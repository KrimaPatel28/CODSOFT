...
root.configure(bg='#ffccff')# type: ignore
text_result = tk.Text(root, height=1, width=16, bg='#ffffff', fg='black', font=("Arial",24))
text_result.grid(columnspan=5, row=0, padx=10, pady=10)
...
btn_mult = tk.Button(root, text="*", command=lambda: add_to_calculation("*"), width=5, font=("Arial",12))
